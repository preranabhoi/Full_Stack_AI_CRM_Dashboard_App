...
const COMPANIES = [
  ...
  ["Soylent Green", "soylentgreen.com"],
...
const run = async () => {
  ...
  let user = await User.findOne({ email: "preranabhoi32@gmail.com" });
  if (user) {
    await Promise.all([
